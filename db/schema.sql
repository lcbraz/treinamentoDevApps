...
--
-- Host: 127.0.0.1    Database: dbapps
-- ------------------------------------------------------
...
CREATE TABLE `conexoes` (
  ...
  CONSTRAINT `conexoes_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
...
--
-- Dumping routines for database 'dbapps'
--
